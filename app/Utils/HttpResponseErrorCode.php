...
class HttpResponseErrorCode
{
    ...
    public const CODE_1010 = 1010; // Not found
    public const CODE_1011 = 1011; // Created fail
    public const CODE_1012 = 1012; // Updated fail.
    public const CODE_1013 = 1013; // Deleted fail.
    ...
    public static function getErrors()
    {
        return [
            ...
            static::CODE_1013 => static::getErrorMessageTrans(static::CODE_1013),
        ];
    }
}
