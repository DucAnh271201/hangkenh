            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col d-flex gap-3">
                        <h2 class="page-title">
                            Danh sách thiết kế của {{ $designer->short_name ?? $designer->name }}
                        </h2>
                        <a href="{{ route('admin.manager-designer.design-list.create',$designer->id) }}" class="btn btn-sm btn-outline-primary">
                            Thêm thiết kế
                        </a>
                    </div>
                </div>
...
@push('script')
    ...
    <script>
        ...
        async function fetchData(page = 1) {
            ...
            let fullUrl = '{{ route('admin.api.designers.design-datable', $designer->id) }}?' + queryString;
