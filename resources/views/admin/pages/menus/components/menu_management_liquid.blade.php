            ...
            <div class="menu-edit ">
                <div id="nav-menu-header">
                    <div class="major-publishing-actions">
                        <label
                            class="menu-name-label howto open-label"
                        ...
                        @elseif(request()->has("menu"))
                            <div class="publishing-action">
                                <a onclick="getmenus()"
                                   name="save_menu"
                                   id="save_menu_header"
                                   class="button button-primary menu-save">Lưu
                                    menu</a>
                                <span class="spinner"
                        ...
                        @else
                            <div class="publishing-action">
                                <a onclick="createnewmenu()"
                                   name="save_menu"
                                   id="save_menu_header"
                                   class="button button-primary menu-save">Tạo
                                    menu</a>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="post-body-content">
                        ...
                        @if(request()->has("menu"))
                            ...
                            <div
                                ...
                                style="">
                                <p>
                                    Đặt từng mục theo thứ tự. Nhấp chuột
                                    trên mũi tên bên phải của
                                    mục để hiển thị nhiều tùy chọn cấu hình hơn.
                                </p>
                            </div>
                                        ...
                                        <div
                                            ...
                                            <p class="field-css-url description description-wide">
                                                <label
                                                    ...
                                                    <input
                                                        type="checkbox"
                                                        id="main_menu_{{$m->id}}"
                                                        class="widefat code edit-menu-main-menu"
                                                        id="main_menu_{{$m->id}}"
                                                        value="{{$m->main_menu}}">
                                                </label>
                                            </p>
                                            ...
                                            <div
                                                ...
                                                <a class="item-delete submitdelete deletion"
                                                   id="delete-{{$m->id}}"
                                                   href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Xóa</a>
                                                <span
                                                    class="meta-sep hide-if-no-js"> | </span>
                                                <a class="item-cancel submitcancel hide-if-no-js button-secondary"
                                                   id="cancel-{{$m->id}}"
                                                   href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Đóng</a>
                                                <span
                                                    class="meta-sep hide-if-no-js"> | </span>
                                                <a onclick="getmenus()"
                                                   class="button button-primary updatemenu"
                                                   id="update-{{$m->id}}"
                                                   href="javascript:void(0)">Cập nhật</a>
                        ...
                        @if(request()->has('action'))
                            <div class="publishing-action">
                                <a onclick="createnewmenu()"
                                   name="save_menu"
                                   id="save_menu_header"
                                   class="button button-primary menu-save">Thêm
                                    menu</a>
                            </div>
                        @elseif(request()->has("menu"))
                            <span class="delete-action"> <a
                                    ...
                                    onclick="deletemenu()"
                                    href="javascript:void(9)">Xóa menu</a> </span>
                            <div class="publishing-action">
