...
@section('content')
    ...
    <div class="page-wrapper">
        <!-- Page header -->
        <x-admin-page-header pre-title="OVERVIEW" title="Vertical layout">
            <x-slot:action>
                <div class="btn-list">
...
@push('script')
    <!-- Libs JS -->
    <script src="{{ asset('assets/libs/tabler/libs/apexcharts/dist/apexcharts.min.js') }}" defer></script>
    <script src="{{ asset('assets/libs/tabler/libs/jsvectormap/dist/js/jsvectormap.min.js') }}" defer></script>
    <script src="{{ asset('assets/libs/tabler/libs/jsvectormap/dist/maps/world.js') }}" defer></script>
    <script src="{{ asset('assets/libs/tabler/libs/jsvectormap/dist/maps/world-merc.js') }}" defer></script>
    <!-- Tabler Core -->
    <script src="{{ asset('assets/libs/tabler/js/demo.min.js') }}" defer></script>
    <script>
        // @formatter:off
